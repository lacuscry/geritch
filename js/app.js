            ...
            function (e, t, s) {
              ...
              function c(e) {
                l.forEach(function (t) {
                  e.addEventListener(t, e === document ? A : I);
                });
              }
              function d(e) {
                ...
                for (var C = 1; C <= E; C++) {
                  ...
                  I && !_ && (q += " qs-event"),
                    ...
                    (d[+A] ||
                      ...
                      !_ &&
                      (q += " qs-disabled"),
                    +S(new Date()) == +A && (q += " qs-current"),
                    +A === g && m && z && (q += " qs-range-start"),
                    +A > g && +A < m && (q += " qs-range-middle"),
                    +A === m && g && z && (q += " qs-range-end"),
                    _ && ((q += " qs-empty"), (P = "")),
                    x.push(
                      '<div class="' +
                        q +
              ...
              function N() {
                ...
                this.inlinePosition &&
                  ...
                  n && delete n.sibling,
                  i.length || M(document, A);
                var o = i.some(function (t) {
                  return t.shadowDom === e;
                });
                for (var a in (e && !o && M(e, I), this)) delete this[a];
                i.length ||
              ...
              t.default = function (e, t) {
                var s = (function (e, t) {
                  ...
                  if (c.sibling) {
                    var T = c.sibling,
                      L = C,
                      A = T.minDate || L.minDate,
                      I = T.maxDate || L.maxDate;
                    (L.sibling = T),
                      (T.sibling = L),
                      (T.minDate = A),
                      (T.maxDate = I),
      ...
      6645: (e, t, s) => {
        ...
        e.exports = function (e, t, s) {
          ...
          if (
            ...
            (x = s.getConstructor(t, e, v, b)), l.enable();
          else if (o(e, !0)) {
            var T = new x(),
              O = T[b](y ? {} : -0, 1) != T,
              L = p(function () {
      ...
      7583: (e, t, s) => {
        ...
        e.exports = function (e, t, s, o, f, m, O) {
          ...
          if (
            ...
            if (((A = { values: M(E), keys: m ? $ : M(x), entries: M(C) }), O))
              for (I in A) (w || _ || !(I in P)) && p(P, I, A[I]);
            else i({ target: t, proto: !0, forced: w || _ }, A);
          return (
            (r && !O) || P[S] === $ || p(P, S, $, { name: f }), (g[t] = $), A
          );
        };
      },
      723: (e, t, s) => {
          ...
          function (e, t, s) {
            ...
            return [
              ...
              function (e, n) {
                ...
                for (var A, I = "", M = 0, k = 0; k < O.length; k++) {
                  for (
                    var _ = h((L = O[k])[0]),
                    ...
                    x(D, void 0 === (A = L[$]) ? A : String(A));
                  var z = L.groups;
                  if (g) {
                    var q = S([_], D, P, a);
                    void 0 !== z && x(q, z);
                    var N = h(i(n, void 0, q));
                  } else N = m(_, a, P, D, z, n);
                  P >= M && ((I += C(a, M, P) + N), (M = P + _.length));
                }
                return I + C(a, M);
              },
            ];
                          ...
                          _ = function (t) {
                            ...
                            S || (S = t),
                              ...
                              (function (t, s) {
                                ...
                                ((p = e.requestAnimationFrame(_)), (S = t));
                          };
                ...
                (function (e, s) {
                  t &&
                    window.addEventListener("online", function () {
                      !(function (e, t) {
                        var s;
                        ((s = fe(e)), pe(s).filter(ge)).forEach(function (t) {
                          M(t, e.class_error), C(t);
                        }),
                          t.update();
                      })(e, s);
                    });
  ...
  (s.n = (e) => {
    ...
    (() => {
          ...
          e.forEach((e) => {
            ...
            function u(t = window) {
              t.addEventListener("mousemove", function (t) {
                ...
                if (
                  s >= window.scrollY ||
                  s + e.offsetHeight >= window.scrollY
                ) {
            ...
            for (let s = 0, i = e.length; s < i; s += 1) {
              ...
              void 0 !== n &&
                ...
                (P(t[i]) && P(r[i])
                  ...
                  : !P(t[i]) && P(r[i])
                  ? ((t[i] = {}),
                    r[i].__swiper__ ? (t[i] = r[i]) : D(t[i], r[i]))
                  : (t[i] = r[i]));
            }
          }
        }
      ...
      function Z(e) {
        ...
        if (d > i.longSwipesMs) {
          ...
          "next" === t.swipeDirection &&
            (f >= i.longSwipesRatio ? t.slideTo(h + g) : t.slideTo(h)),
            "prev" === t.swipeDirection &&
              (f > 1 - i.longSwipesRatio ? t.slideTo(h + g) : t.slideTo(h));
        } else {
      ...
      window.addEventListener("load", function (e) {
        ye(),
          document.querySelector(".body-slider-main__swiper") &&
            new pe(".slider-main .swiper ", {
              modules: [ve, me, ge],
              ...
              preloadImages: !1,
              lazy: { loadPrevNext: !0 },
              pagination: { el: ".body-slider-main__current", clickable: !0 },
              breakpoints: { 320: { autoHeight: !0 }, 768: { autoHeight: !1 } },
              on: {
                init: function () {
                  document
                    .querySelectorAll(
                      ".body-slider-main__current .swiper-pagination-bullet"
                    )
                    .forEach((e, t) => {
                      let s = 0;
                ...
                breakpoint: function (e, t) {
                  !1 === t.autoHeight &&
                    (document.querySelector(
                      ".body-slider-main__swiper"
                    ).style.height = "auto");
                },
              },
            }),
          document.querySelector(".blog-main__slider") &&
            new pe(".blog-main__slider", {
              modules: [ve, me],
              ...
              lazy: { loadPrevNext: !0 },
              breakpoints: {
                500: { slidesPerView: 2, autoHeight: !0 },
                992: { slidesPerView: 3, autoHeight: !1 },
              },
              on: {
                init: function () {
                  document
                    .querySelectorAll(
                      ".blog-main__swiper.swiper-pagination-bullet"
                    )
                    .forEach((e, t) => {
                      let s = 0;
                      t < 10 && (s = "0"), (e.innerHTML = `${s}${t + 1}`);
                ...
                breakpoint: function (e, t) {
                  !1 === t.autoHeight &&
                    (document.querySelector(".blog-main__swiper").style.height =
                      "auto");
                },
              },
            }),
          document.querySelector(".gallery-main__slider") &&
            new pe(".gallery-main__slider", {
              modules: [ve, me],
              autoplay: { delay: 3e3, disableOnInteraction: !1 },
              observer: !0,
              observeParents: !0,
              ...
              preloadImages: !1,
              lazy: { loadPrevNext: !0 },
              breakpoints: { 200: { centeredSlides: !0 }, 768: {} },
            });
      });
      s(9399), s(3542);
      var be,
      ...
      var Me,
        ...
        Be = /auto|scroll/,
        je = /^tb|vertical/,
        Re = /msie|trident/i.test(qe.navigator && qe.navigator.userAgent),
        Fe = function (e) {
        ...
        Ge = function (e, t) {
          ...
          if ($e(e)) return Ne.set(e, He), He;
          var s = getComputedStyle(e),
            i = De(e) && e.ownerSVGElement && e.getBBox(),
            n = !Re && "border-box" === s.boxSizing,
            r = je.test(s.writingMode || ""),
            o = !i && Be.test(s.overflowY || ""),
            a = !i && Be.test(s.overflowX || ""),
            l = i ? 0 : Fe(s.paddingTop),
            c = i ? 0 : Fe(s.paddingRight),
            d = i ? 0 : Fe(s.paddingBottom),
            u = i ? 0 : Fe(s.paddingLeft),
            h = i ? 0 : Fe(s.borderTopWidth),
            p = i ? 0 : Fe(s.borderRightWidth),
            f = i ? 0 : Fe(s.borderBottomWidth),
            g = u + c,
            m = l + d,
            v = (i ? 0 : Fe(s.borderLeftWidth)) + p,
            y = h + f,
            b = a ? e.offsetHeight - y - e.clientHeight : 0,
            w = o ? e.offsetWidth - v - e.clientWidth : 0,
            S = n ? g + v : 0,
            x = n ? m + y : 0,
            E = i ? i.width : Fe(s.width) - S - w,
            C = i ? i.height : Fe(s.height) - x - b,
            T = E + g + w + v,
            O = C + m + b + y,
            L = ke({
              devicePixelContentBoxSize: We(
              ...
              borderBoxSize: We(T, O, r),
              contentBoxSize: We(E, C, r),
              contentRect: new Pe(u, l, E, C),
            });
          return Ne.set(e, L), L;
        },
        Ve = function (e, t, s) {
        ...
        et = 0,
        tt = { attributes: !0, characterData: !0, childList: !0, subtree: !0 },
        st = [
          "resize",
          "load",
          "transitionend",
        ...
        ut = (function () {
          ...
          return (
            ...
            (e.observe = function (e, t, s) {
              ...
              dt(i.observationTargets, t) < 0 &&
                (n && Ae.push(i),
                i.observationTargets.push(new at(t, s && s.box)),
                ot(1),
                rt.schedule());
            }),
            (e.unobserve = function (e, t) {
              var s = ct.get(e),
                i = dt(s.observationTargets, t),
                n = 1 === s.observationTargets.length;
              i >= 0 &&
                (n && Ae.splice(Ae.indexOf(s), 1),
      ...
      Se() &&
        window.addEventListener("resize", function () {
          vt !== window.devicePixelRatio &&
            ((vt = window.devicePixelRatio), (mt = null));
        });
      var bt = (function () {
        function e(t, s) {
          var i = this;
          (this.onScroll = function () {
            ...
            e.instances.has(this.el) ||
              ((this.recalculate = Ee()(this.recalculate.bind(this), 64)),
              (this.onMouseMove = Ee()(this.onMouseMove.bind(this), 64)),
      ...
      var xt = (function () {
        ...
        return (
          ...
          (e.prototype.find = function (e) {
            return Et(this._getSelector(e, this.selector));
          }),
      ...
      var Ot = function (e, t, s, i) {
          void 0 === s && (s = 0);
          var n = Et(e).attr("data-lg-size") || i;
          if (n) {
            var r = n.split(",");
            if (r[1])
        ...
        Lt = function (e, t, s, i, n) {
          if (n) {
            var r = Et(e).find("img").first();
            if (r.get()) {
        ...
        qt = "lgAfterAppendSlide",
        Nt = "lgInit",
        Bt = "lgHasVideo",
        jt = "lgContainerResize",
        Rt = "lgUpdateSlides",
        Ft = "lgAfterAppendSubHtml",
        Wt = "lgBeforeOpen",
        Ht = "lgAfterOpen",
        Gt = "lgSlideItemLoad",
        Vt = "lgBeforeSlide",
        ...
        Kt = "lgDragMove",
        Zt = "lgDragEnd",
        Qt = "lgBeforeNextSlide",
        Jt = "lgBeforePrevSlide",
        es = "lgBeforeClose",
        ts = "lgAfterClose",
        ss = 0,
        is = (function () {
          ...
          return (
            (e.prototype.generateSettings = function (e) {
              if (
                ...
                var t = St(
                  St({}, this.settings.mobileSettings),
                  this.settings.mobileSettings
                );
                this.settings = St(St({}, this.settings), t);
              }
            }),
            ...
            (e.prototype.getSlideItem = function (e) {
              return Et(this.getSlideItemId(e));
            }),
              ...
              if ("this" === this.settings.selector) this.items.push(this.el);
                ...
                if ("string" == typeof this.settings.selector)
                  if (this.settings.selectWithin) {
                    var e = Et(this.settings.selectWithin);
            ...
            (e.prototype.openGallery = function (e, t) {
              ...
              if ((void 0 === e && (e = this.settings.index), !this.lgOpened)) {
                ...
                this.zoomFromOrigin &&
                  ...
                  (r = Lt(t, this.outer, a, l, this.currentImageSize))),
            ...
            (e.prototype.addHtml = function (e) {
                ...
                if (t) {
                  ...
                  ("." !== i && "#" !== i) ||
                    (t =
                      ...
                      !this.settings.dynamic
                        ? Et(this.items).eq(e).find(t).first().html()
                        : Et(t).first().html());
                } else t = "";
              if (".lg-item" !== this.settings.appendSubHtmlTo)
                ...
                var n = Et(this.getSlideItemId(e));
                s
                  ? n.load(s)
            ...
            (e.prototype.getDummyImageContent = function (e, t, s) {
              var i;
              if ((this.settings.dynamic || (i = Et(this.items).eq(t)), i)) {
                var n = void 0;
                if (
            ...
            (e.prototype.addSlideVideoInfo = function (e) {
              ...
              e.forEach(function (e, s) {
                (e.__slideVideoInfo = $t(e.src, !!e.video, s)),
                  e.__slideVideoInfo &&
            ...
            (e.prototype.loadContent = function (e, t) {
              ...
              if (
                ...
                (r || p) &&
                  ...
                  this.LGel.trigger(qt, { index: e }),
                  this.lGalleryOn &&
                    ".lg-item" === this.settings.appendSubHtmlTo &&
                    this.addHtml(e);
              }
              var T = 0;
              v && !Et(document.body).hasClass("lg-from-hash") && (T = v),
                this.isFirstSlideWithZoomAnimation() &&
                  (setTimeout(function () {
                    n.removeClass(
              ...
              "lg-slide" !== this.settings.mode &&
                ...
                setTimeout(function () {
                  ...
                  if (
                    ...
                    var a = Et(s.target);
                    n.isPosterElement(a) && n.LGel.trigger(Xt);
                  }
                ...
                this.$inner.on("touchend.lg", function (r) {
                  if ("swipe" === e.touchAction) {
                    if (i) (i = !1), e.touchEnd(s, t, r);
                      ...
                      var o = Et(r.target);
                      e.isPosterElement(o) && e.LGel.trigger(Xt);
                    }
            ...
            (e.prototype.enableDrag = function () {
              ...
              this.settings.enableDrag &&
                ...
                Et(window).on("mousemove.lg.global" + this.lgId, function (r) {
                  i &&
                    e.lgOpened &&
                    ((n = !0),
                ...
                Et(window).on("mouseup.lg.global" + this.lgId, function (r) {
                  if (e.lgOpened) {
                    var o = Et(r.target);
                    n
                      ? ((n = !1), e.touchEnd(s, t, r), e.LGel.trigger(Zt))
                      : e.isPosterElement(o) && e.LGel.trigger(Xt),
                      i &&
                        ((i = !1),
            ...
            (e.prototype.keyPress = function () {
              var e = this;
              Et(window).on("keydown.lg.global" + this.lgId, function (t) {
                e.lgOpened &&
                  !0 === e.settings.escKey &&
                  27 === t.keyCode &&
                  (t.preventDefault(),
            ...
            (e.prototype.closeGallery = function (e) {
              ...
              this.LGel.trigger(es), Et(window).scrollTop(this.prevScrollTop);
              var s,
              ...
              return (
                ...
                setTimeout(function () {
                  t.zoomFromOrigin &&
                    ...
                    t.$inner.empty(),
                    t.lgOpened && t.LGel.trigger(ts, { instance: t }),
              ...
              return (
                setTimeout(function () {
                  e.destroyModules(!0),
                    ...
                    Et(window).off(".lg.global" + e.lgId),
                    e.LGel.off(".lg"),
                    e.$container.remove();
                }, t),
                t
      ...
      const ns = function (e, t) {
        ...
        rs = document.querySelectorAll("[data-gallery]");
      if (rs.length) {
        let t = [];
        rs.forEach((e) => {
          t.push({
      ...
      const as = document.querySelector(".menu-main");
      let ls = document.querySelector(".menu-main__link_2"),
        cs = document.querySelector(".menu-main__link_3");
      ls.addEventListener(
        "mouseover",
        function () {
          as.classList.add("bg-2"),
            as.classList.contains("bg-1") && as.classList.remove("bg-1");
        },
        !1
      ),
        ls.addEventListener(
          "mouseout",
          function () {
            as.classList.remove("bg-2"), as.classList.add("bg-1");
          },
          !1
        ),
        cs.addEventListener(
        ...
        cs.addEventListener(
          "mouseout",
          function () {
            as.classList.remove("bg-3"), as.classList.add("bg-1");
          },
          !1
        ),
        (window.FLS = !0),
        ...
        (function () {
          ...
          const e = document.querySelector("header.header"),
            ...
            n = document.documentElement.querySelector(".body-slider-main");
          let r,
            o = 0;
            ...
            clearTimeout(r),
              l >= i
                ? (!e.classList.contains("_header-scroll") &&
                  ...
                  t &&
                    (l > o
                      ? n.classList.contains("_watcher-view") &&
